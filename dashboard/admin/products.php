    ...
    if (isset($_POST['action'])) {
        switch ($_POST['action']) {
            case 'add':
                ...
                if (!empty($nama_produk) && $harga > 0 && $id_kategori > 0 && $id_supplier > 0) {
                    $product_data = [
...
try {
    ...
    // Get suppliers
    $suppliers = $crud->read('users', ['role' => 'supplier'], '*', 'id ASC');
} catch (Exception $e) {
    $products = ['success' => false, 'data' => []];
    $categories = ['success' => false, 'data' => []];
    $suppliers = ['success' => false, 'data' => []];
}
?>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    ...
                    <a href="products.php" class="text-merah font-semibold transition">Produk</a>
                ...
                <div class="mobile-menu hidden absolute top-20 left-0 right-0 bg-white shadow-xl z-50 md:hidden">
                    <div class="flex flex-col py-4 space-y-4 px-6">
                        ...
                        <a href="products.php" class="text-merah font-semibold transition py-2">Produk</a>
                    ...
                    <table class="w-full">
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                $supplier_name = $supplier['success'] ? ($supplier['data']['nama_lengkap'] ?? $supplier['data']['username']) : 'Tidak Diketahui';
                            ?>
                            <tr class="border-b hover:bg-gray-50">
                                ...
                                <td class="py-3 px-4"><?php echo htmlspecialchars($supplier_name); ?></td>
        ...
        <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full max-w-2xl bg-white shadow-2xl rounded-2xl p-6">
            ...
            <form id="product-form" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label for="id_supplier" class="block text-gray-700 font-medium mb-2">Supplier *</label>
                        <select 
                            id="id_supplier" 
                            name="id_supplier" 
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-merah focus:border-transparent outline-none transition"
                        ...
                        >
                            ...
                            <?php if ($suppliers['success'] && !empty($suppliers['data'])): ?>
                            <?php foreach ($suppliers['data'] as $supplier): ?>
                            <option value="<?php echo $supplier['id']; ?>"><?php echo htmlspecialchars($supplier['nama_lengkap'] ?? $supplier['username']); ?></option>
                            <?php endforeach; ?>
                            <?php endif; ?>
                        </select>
                    </div>
