...
// Admin dashboard for KDMP application
...
function get_admin_stats() {
    try {
        ...
        $total_users = $crud->count('users');
        $total_products = $crud->count('produk');
        $total_orders = $crud->count('pesanan');
        $pending_orders = $crud->count('pesanan', ['status_pesanan' => 'pending']);
        
        return [
            'total_users' => $total_users['success'] ? $total_users['count'] : 0,
            'total_products' => $total_products['success'] ? $total_products['count'] : 0,
            'total_orders' => $total_orders['success'] ? $total_orders['count'] : 0,
...
<head>
    ...
    <title>Dashboard Admin - Dapur Suplai</title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    ...
                    <a href="orders.php" class="text-gray-700 hover:text-merah font-semibold transition">Pesanan</a>
                ...
                <div class="mobile-menu hidden absolute top-20 left-0 right-0 bg-white shadow-xl z-50 md:hidden">
                    <div class="flex flex-col py-4 space-y-4 px-6">
                        ...
                        <a href="orders.php" class="text-gray-700 hover:text-merah font-semibold transition py-2">Pesanan</a>
    ...
    <main class="pt-24 pb-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                ...
                <p class="text-gray-600">Dashboard administrator untuk mengelola seluruh sistem</p>
            </div>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full">
                        ...
                        <tbody>
                            ...
                            try {
                                $crud = new DatabaseCRUD();
                                $recent_orders = $crud->read('pesanan', [], '*', 'tanggal_pesan DESC', 5);
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <a href="users.php" class="bg-white rounded-2xl shadow-lg p-6 card-hover flex items-center">
                    <div class="p-3 rounded-full bg-indigo-100 text-indigo-600">
                        <i class="fas fa-users text-2xl"></i>
                    </div>
                    <div class="ml-4">
                        <h3 class="font-bold text-lg text-gray-800">Kelola Pengguna</h3>
                        <p class="text-gray-600">Tambah, edit, atau hapus pengguna</p>
                    </div>
                </a>
