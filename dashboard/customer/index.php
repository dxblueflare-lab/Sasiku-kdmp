...
// Customer dashboard for KDMP application
...
<head>
    ...
    <title>Dashboard Customer - Dapur Suplai</title>
            ...
            <div class="flex justify-between items-center h-20">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-600 font-medium">Customer Dashboard</p>
                    </div>
                </div>
                ...
                <div class="hidden md:flex items-center space-x-8">
                    ...
                    <a href="../customer/orders.php" class="text-gray-700 hover:text-merah font-semibold transition">Pesanan Saya</a>
                    <a href="../customer/profile.php" class="text-gray-700 hover:text-merah font-semibold transition">Profil</a>
                ...
                <div class="mobile-menu hidden absolute top-20 left-0 right-0 bg-white shadow-xl z-50 md:hidden">
                    <div class="flex flex-col py-4 space-y-4 px-6">
                        ...
                        <a href="../customer/orders.php" class="text-gray-700 hover:text-merah font-semibold transition py-2">Pesanan Saya</a>
                        <a href="../customer/profile.php" class="text-gray-700 hover:text-merah font-semibold transition py-2">Profil</a>
    ...
    <main class="pt-24 pb-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                ...
                <p class="text-gray-600">Dashboard pelanggan untuk mengelola pesanan dan profil Anda</p>
            </div>
                ...
                <div class="bg-white rounded-2xl shadow-lg p-6 card-hover">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-gray-800"><?php echo $stats['pending_orders']; ?></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6 mb-12">
                <div class="flex justify-between items-center mb-6">
                    ...
                    <a href="../customer/orders.php" class="text-merah font-medium hover:underline">Lihat Semua</a>
                </div>
                    ...
                    <table class="w-full">
                        ...
                        <tbody>
                            ...
                            try {
                                ...
                                $recent_orders = $crud->read('pesanan', ['id_user' => $user['id']], '*', 'tanggal_pesan DESC', 5);
                                
                                if ($recent_orders['success'] && !empty($recent_orders['data'])) {
                                    foreach ($recent_orders['data'] as $order) {
                                        $status_class = '';
                                        ...
                                        <tr class="border-b hover:bg-gray-50">
                                            ...
                                            <td class="py-3 px-4">
                                                <a href="../customer/order_detail.php?id=<?php echo $order['id']; ?>" class="text-merah hover:underline">Detail</a>
                                            </td>
                                        </tr>
                                        <?php
                                    }
                                ...
                                ?>
                                <tr>
                                    <td colspan="5" class="py-8 px-4 text-center text-red-500">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <a href="../shop.php" class="bg-white rounded-2xl shadow-lg p-6 card-hover flex items-center">
                    <div class="p-3 rounded-full bg-indigo-100 text-indigo-600">
                        <i class="fas fa-shopping-bag text-2xl"></i>
                    </div>
                    <div class="ml-4">
                        <h3 class="font-bold text-lg text-gray-800">Mulai Belanja</h3>
                        <p class="text-gray-600">Temukan produk yang Anda butuhkan</p>
                    </div>
                </a>

                <a href="../customer/orders.php" class="bg-white rounded-2xl shadow-lg p-6 card-hover flex items-center">
                    <div class="p-3 rounded-full bg-purple-100 text-purple-600">
                        <i class="fas fa-list text-2xl"></i>
                    </div>
                    <div class="ml-4">
                        <h3 class="font-bold text-lg text-gray-800">Lihat Pesanan</h3>
                        <p class="text-gray-600">Kelola dan lacak pesanan Anda</p>
                    </div>
                </a>

                <a href="../customer/profile.php" class="bg-white rounded-2xl shadow-lg p-6 card-hover flex items-center">
